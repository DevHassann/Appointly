...
import { MeetingsTable, WalletsTable } from "../Includes/WalletPaymentsTables";
import { PaymentModalBox } from "../../ModalBoxes";
import Loader from "../../Loader";

const UserWalletAndPayments = () => {
      ...
      {user == null ? (
        ...
        <>
          <div className="p-4 bg-white mb-4">
            ...
            {/* Boxes */}
            <div className="flex gap-19 bg-white">
              {/* Box 01 */}
              <div
            ...
            >
              {selectedTab === "Meetings" && <MeetingsTable />}
              {selectedTab === "Wallets" && <WalletsTable />}
            </div>
          </div>
        </>
      )}
...
export default UserWalletAndPayments;
